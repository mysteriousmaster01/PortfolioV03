...
import ProfilePic from "../../public/images/profile/my-profile.png";
        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-6 dark:bg-dark dark:border-light xl:col-span-4 lg:order-1 lg:col-span-8">
              <div className="absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-light lg:w-[101%] lg:h-[102%]" />
              <Image
                src={ProfilePic}
                alt="jay prajapati"
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center lg:order-3">

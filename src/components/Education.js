      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-2 xs:ml-2">
          <Details
            ...
            time="2019-2023"
            place="Sardar Vallabhbhai Patel Institute of Technology, Vasad."
            info="Relevent Course Included Data Structures and Algorithms, Computer Vision, Software Engineering and Object Oriente Programming System."
          />
        </ul>
      </div>
    </div>
